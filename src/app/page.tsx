...
export default function LandingPage() {
  ...
  return (
    <main className="relative">
      ...
      <div className="fixed bottom-6 left-6 z-40 bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-2xl p-4 shadow-xl max-w-[280px] transition-all duration-300 hover:shadow-2xl">
