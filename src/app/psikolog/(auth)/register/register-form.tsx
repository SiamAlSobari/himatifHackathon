...
import { registerPsychologist } from "@/lib/actions/register-psychologist"
    ...
    <form onSubmit={handleSubmit} className="space-y-3.5">
      ...
      <div className="space-y-2.5 pt-1 border-t border-black/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          ...
          <div className="space-y-1">
            <Label htmlFor="imageUrl" className="text-[#0D1B2A] font-bold text-[10px] tracking-wider uppercase ml-1">
              URL Foto Profil
            </Label>
            <div className="relative">
