      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col gap-10 mt-16">
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-sm">
              ...
              >
                ...
                />
                {/* Teal accent corner */}
                <div className="absolute bottom-0 right-0 w-14 h-14 bg-[#1A8A7A] rounded-tl-2xl z-10" />
              </div>
        ...
        <div className="grid grid-cols-3 gap-5">
          {features.map((f, i) => (
            <div
              key={i}
              className="bg-white rounded-3xl px-8 py-8 text-center border-2 border-black/10 hover:border-[#1A8A7A] transition-all duration-300"
            >
