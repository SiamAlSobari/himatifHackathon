  ...
  return (
    <section id="validasi" className="bg-background py-20 px-6 transition-colors duration-500">
      <div className="max-w-3xl mx-auto">
        {/* CTA Card */}
        <div className="bg-foreground rounded-3xl px-8 py-14 md:px-16 md:py-20 text-center relative overflow-hidden transition-colors duration-500 animate-fade-up duration-700 shadow-premium">
          {/* Decorative glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 bg-[#1A8A7A]/20 blur-3xl rounded-full pointer-events-none" />

          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-5 relative z-10 animate-fade-up delay-100 duration-700">
            Mulailah Mendengarkan <br />
            <span className="text-primary transition-colors duration-500">Dirimu</span> Hari Ini.
          </h2>

          <p className="text-white/60 text-base md:text-lg leading-relaxed mb-10 max-w-lg mx-auto relative z-10 animate-fade-up delay-200 duration-700">
